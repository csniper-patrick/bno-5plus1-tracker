export default {
  ...
  instruction: {
    ...
    overview: {
      ...
      feature1_title: '180日滾動規則計算',
      feature1_desc: '自動計算任何 12 個月滾動週期內的累積離境天數。',
      feature2_title: '100% 本地儲存與備份',
      feature2_desc: '資料完全本地化，支援一鍵匯出及匯入加密 ZIP / YAML 備份檔案。',
    ...
    faq: {
      ...
      a1: '追蹤工具透過 Segment Tree 資料結構自動掃描您連續居留期內每一個 365 天滾動區間，持續評估離境天數，確保沒有任何區間超過 180 天限制，並自動推算延誤後的永居目標日期。',
