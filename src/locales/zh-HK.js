export default {
  ...
  instruction: {
    ...
    step2: {
      ...
      warning: '規則警告：在 5 年 qualifying period 中，任何滾動 12 個月內累積離境不可超過 180 天。',
      action_btn: '新增離境記錄',
      caption1: '新增離境記錄表格示範',
    ...
    step3: {
      ...
      point1: '總覽與 NI 卡片：於頂層檢視永居準備進度環形圖，並在左側/頂層快速填寫國民保險號碼 (NI) 及申請狀態。',
      point2: '考卷與語言證明：記錄 Life in the UK 考試合格編號 (URN)、考場及 B1 英文能力證明細節。',
      point3: '記錄完整在英住址歷史（搬入/搬出日期、郵政編號及房屋業權/租約類型）。',
      point4: '按年度整理居住證明（P60、Council Tax、銀行月結單、水電煤帳單、租約），並可將文件庫上載的檔案直接連結至特定項目。',
      privacy_note: '上傳之文件附件（PDF、圖片、掃描檔）均安全儲存於本地瀏覽器 IndexedDB 中，可隨時在瀏覽器中預覽或以新分頁開啟。',
  ...
  profiles: {
    ...
    delete_confirm_body: '您確定要刪除檔案「{name}」嗎？此檔案的所有離境紀錄、簽證日期及文件清單將被永久刪除，無法復原。',
