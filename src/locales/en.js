export default {
  ...
  absence: {
    ...
    copy_to_profile: 'Shared With...',
    copy_to_profile_title: 'Select Shared Profiles',
    copy_to_profile_desc: 'Select the profile(s) sharing this absence record (uncheck to remove):',
    select_all_profiles: 'Select All',
    clear_all_profiles: 'Clear Selection',
    copy_action: 'Save Selection',
    ...
    save_dates_success: 'Key Visa & Settlement dates saved!',
    record_updated_success: 'Absence record updated!',
    record_added_success: 'Absence record added!',
    record_deleted_success: 'Absence record deleted.',
  ...
  document: {
    ...
    housing_rented: 'Rented (Private / Social)',
    housing_owned: 'Owned / Mortgage',
    housing_with_family: 'Living with Family / Friends',
    housing_other: 'Other (Student Accommodation / Temporary)',
    ...
    link_type_checklist: 'Residence Checklist (Years 1-5)',
    link_type_address: 'UK Address History',
  ...
  instruction: {
    ...
    overview: {
      ...
      feature1_title: '180-Day Rolling Rule (ILR)',
      feature1_desc: 'Scans every 365-day rolling window for max 180 days absent limit.',
      feature2_title: 'Naturalisation Rules',
      feature2_desc: 'Tracks 450-day 5-year limit & 90-day final 12-month post-ILR limit.',
      feature3_title: '28-Day Early ILR Window',
      feature3_desc: 'Computes earliest ILR date (28 days before 5 yrs) & visa expiry alerts.',
      feature4_title: '100% Privacy & Backup',
      feature4_desc: 'Data remains 100% local. Easily export & import ZIP / YAML backups.',
    ...
    step5: {
      header: 'Step 5: Manage Multi-Applicant Profiles & Companion Records',
      desc: 'Track residency milestones and document checklists for your entire family (Main Applicant, Spouse, Dependents) with complete data isolation, and manage joint travel companion records seamlessly.',
      ...
      point5:
        'Manage shared companions: Click the action menu (⋮) on any trip in the Absence Records table, choose "Shared With...", and check or uncheck family members. Checked profiles will automatically share the journey, while unchecking clears the trip from that profile.',
      action_btn: 'Open Profile Drawer Section',
      copy_feature_tip:
        'Family Travel Tip: When your family travels abroad together, log the trip once under the Main Applicant profile and use "Shared With..." to select Spouse and Children profiles. Any subsequent updates to the trip will automatically synchronize across all shared profiles, and unchecking a profile will remove it seamlessly.',
      caption1: 'Multi-Profile Switcher & Drawer Demonstration',
      caption2: 'Select Shared Profiles Dialog Demonstration',
    },
    faq: {
      ...
      q8: 'How do I select or clear shared companion profiles for an absence record?',
      a8: 'When multiple profiles exist, locate the trip in the Absence Records table, click the action menu button (⋮) on that row, and select "Shared With...". In the dialog that appears, check or uncheck target profile(s) and click "Save Selection". The trip details will be automatically synchronized to selected profiles or cleared from unselected profiles.',
    },
  },
  profiles: {
    ...
    updated_success: 'Profile name updated!',
    deleted_success: 'Profile deleted.',
  },
}
