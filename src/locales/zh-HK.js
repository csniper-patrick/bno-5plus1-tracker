export default {
  ...
  instruction: {
    ...
    step3: {
      ...
      desc: '集中管理 Life in the UK 考卷成績、B1 英文能力證明、國民保險號碼 (NI)、居住地址歷史紀錄，以及每年居住證明文件組合。',
      point1: '記錄 Life in the UK 考試合格編號 (URN) 及 B1 英文能力證明細節。',
      point2: '記錄國民保險號碼 (NI)、申請狀態並上載 HMRC 官方信件。',
    ...
    faq: {
      ...
      q6: '如何在系統中記錄國民保險號碼 (NI) 與住址歷史？',
      a6: '在「文件與資格追蹤」頁面中，展開「國民保險號碼 (NI)」區塊即可輸入 NIN 號碼格式（例如 QQ123456C）、申請狀態及上載 HMRC 信件。您亦可在「住址歷史紀錄」中登記過往居住地址，並直接將住址證明檔案連結至特定住址。',
