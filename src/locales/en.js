export default {
  ...
  absence: {
    ...
    copy_to_profile: 'Share with...',
    copy_to_profile_title: 'Share Record with Other Profiles',
    copy_to_profile_desc: 'Select the profile(s) you would like to share this absence record with:',
    select_all_profiles: 'Select All Profiles',
    copy_action: 'Share Record',
    copy_record_success: 'Record successfully shared with {name}!',
    copy_record_multi_success: 'Record successfully shared with {count} profile(s)!',
    no_target_profiles_selected: 'Please select at least one profile to share with.',
  ...
  instruction: {
    ...
    step5: {
      header: 'Step 5: Manage Multi-Applicant Profiles & Share Records',
      desc: 'Track residency milestones and document checklists for your entire family (Main Applicant, Spouse, Dependents) with complete data isolation, and share joint travel records seamlessly.',
      ...
      point5:
        'Share absence records across profiles: Click the action menu (⋮) on any trip in the Absence Records table, choose "Share with...", select target family member(s), and share instantly. Updates to shared trips will automatically stay in sync across all profiles.',
      action_btn: 'Open Profile Drawer Section',
      copy_feature_tip:
        'Family Travel Tip: When your family travels abroad together, log the trip once under the Main Applicant profile and use "Share with..." to share the record to Spouse and Children profiles in one click. Any subsequent updates to the trip will automatically synchronize across all shared profiles.',
      caption1: 'Multi-Profile Switcher & Drawer Demonstration',
      caption2: 'Share Absence Record with Other Profiles Dialog Demonstration',
    },
    faq: {
      ...
      q8: "How do I share an absence record with another family member's profile?",
      a8: 'When multiple profiles exist, locate the trip in the Absence Records table, click the action menu button (⋮) on that row, and select "Share with...". In the dialog that appears, check the target profile(s) and click "Share Record". The trip details (dates, stops, and reason) will be shared to those profiles and will automatically synchronize when updated in any profile.',
    },
  },
  profiles: {
