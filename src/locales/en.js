export default {
  ...
  instruction: {
    ...
    faq: {
      ...
      q1: 'How is the 180-day rolling rule calculated?',
      a1: 'The Home Office checks any 12-month rolling period during the 5-year qualifying period. The tracker evaluates every single day window to ensure no 365-day block exceeds 180 days absent.',
      q2: 'Do travel departure and arrival days count as absences?',
      a2: 'No. According to Home Office guidance, days spent travelling where part of the day was spent in the UK do NOT count as full days of absence.',
      q3: 'Is my personal data uploaded to any server?',
      a3: 'No! BNO 5+1 Tracker is 100% client-side and offline-capable. All data stays in your browser IndexedDB.',
    },
  },
}
