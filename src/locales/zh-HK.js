export default {
  ...
  instruction: {
    ...
    overview: {
      ...
      p1: 'BNO 5+1 Tracker 是一款專為香港 BNO 簽證持有人設計的離線優先網頁應用程式，用於精確計算連續居留期、累積離境天數及各項永居關鍵日期。',
    ...
    step3: {
      header: 'Step 3：管理永居必備文件與證明',
      desc: '集中管理 Life in the UK 考卷成績、B1 英文能力證明，以及每年居住證明文件組合。',
      point1: '記錄 Life in the UK 考試合格編號及證書細節。',
      point2: '上傳或記錄 B1 / B2 / 認可學位英文能力證明。',
      point3: '按年度整理居住證明（P60、Council Tax、銀行月結單、水電煤帳單、租約）。',
      privacy_note: '上傳之文件附件均安全儲存於本地瀏覽器 IndexedDB 中。',
      action_btn: '開啟文件清單',
      caption: '文件清單與居住證明管理介面',
    },
    step4: {
      header: 'Step 4: 備份資料與查閱官方指引',
