export default {
  ...
  absence: {
    ...
    copy_to_profile_title: 'Copy Record to Other Profiles',
    copy_to_profile_desc: 'Select the profile(s) you would like to copy this absence record to:',
    select_all_profiles: 'Select All Profiles',
    copy_action: 'Copy Record',
    copy_record_success: 'Record successfully copied to {name}!',
    copy_record_multi_success: 'Record successfully copied to {count} profile(s)!',
    no_target_profiles_selected: 'Please select at least one profile to copy to.',
